...
[![release:prime](https://img.shields.io/github/actions/workflow/status/logfoxai/composewatch/release.yml?branch=main&label=release%3Aprime)](https://github.com/logfoxai/composewatch/actions/workflows/release.yml)
[![release:prod](https://img.shields.io/github/actions/workflow/status/logfoxai/composewatch/release.yml?branch=prod&label=release%3Aprod)](https://github.com/logfoxai/composewatch/actions/workflows/release.yml)
